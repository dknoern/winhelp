...
Add-Content 'C:\startup.ps1' 'Start-Service sshd'

Add-Content 'C:\postinstall.txt' 'creating startup cmd file'
Add-Content 'C:\Users\davidk\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\startup.cmd' 'PowerShell -Command "Set-ExecutionPolicy Unrestricted" >> "C:\startlog.txt" 2>&1; PowerShell C:\startup.ps1 >> "C:\startlog.txt" 2>&1'
